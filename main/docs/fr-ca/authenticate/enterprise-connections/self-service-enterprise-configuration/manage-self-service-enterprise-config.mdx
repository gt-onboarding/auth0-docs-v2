...
<Tabs>
  ...
  <Tab title="Management API">
    ...
    **Exemple de corps de requête**
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      Notez que cette requête **écrase** tout message actuellement défini pour le profil libre-service. Assurez-vous que votre requête comprend le texte complet que vous voulez afficher aux administrateurs de vos clients.
    </Callout>
...
<Tabs>
  ...
  <Tab title="Management API">
    ...
    **Exemple de corps de requête**
    ...
    After you receive the ticket URL, share the link with your customer admin to grant them access to the self-service assistant. L&#39;assistant les guide dans la configuration de la connexion SSO. To learn more about that experience, review [Self-service assistant experience](/docs/fr-ca/authenticate/enterprise-connections/self-service-enterprise-configuration#self-service-assistant-experience).
