...
* Assurez-vous que l’**URL de rappel** indiquée dans le fichier HTML figure aussi dans le champ **URL de rappel autorisées** de votre application. Pour ce faire, allez à [Dashboard &gt; Applications &gt; Applications](https://manage.auth0.com/#/applications), sélectionnez le nom de votre application, puis repérez **URL de rappel autorisées**.
