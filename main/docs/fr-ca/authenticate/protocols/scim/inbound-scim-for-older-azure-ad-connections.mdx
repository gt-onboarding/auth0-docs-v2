...
description: Configurez SCIM entrant sur une connexion Azure AD Auth0 existante antérieure au connecteur Azure actuel afin qu’elle puisse également provisionner et déprovisionner ses utilisateurs dans Auth0.
---
