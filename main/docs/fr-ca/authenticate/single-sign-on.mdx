...
description: Auth0 Single Sign-On (SSO) permet aux utilisateurs de s’authentifier une seule fois et d’accéder à toutes les applications du même locataire sans avoir à saisir de nouveau leurs renseignements d’authentification.
---
