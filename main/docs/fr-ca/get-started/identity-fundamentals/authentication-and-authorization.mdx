---
description: Comprenez la différence entre l’authentification et l’autorisation, comment elles fonctionnent ensemble et comment Auth0 gère chacune d’elles dans vos applications.
