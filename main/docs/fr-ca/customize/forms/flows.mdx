---
description: Découvrez comment créer une logique côté serveur à l’aide de Flows afin d’ajouter une logique décisionnelle et des intégrations externes à Forms.
title: Flows
sidebarTitle: Aperçu
---
