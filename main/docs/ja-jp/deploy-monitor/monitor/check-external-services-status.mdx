---
description: Social および Enterprise アイデンティティプロバイダーなどの外部サービスの状態を確認し、アップストリームの障害による Auth0 login の失敗を診断します。
title: 外部サービスの状態を確認する
---

問題の原因をすばやく切り分けられるよう、Auth0 の接続で使用しているリモートの <Tooltip tip="アイデンティティプロバイダー（IdP）: デジタルアイデンティティを保存および管理するサービス。" cta="用語集を見る" href="/docs/ja-jp/glossary?term=identity+providers">アイデンティティプロバイダー</Tooltip> を監視することをおすすめします。
