...
* [サンプルユーザープロファイル](/docs/ja-jp/manage-users/user-accounts/user-profiles/sample-user-profiles)
* [ユーザープロファイルのルート属性](/docs/ja-jp/manage-users/user-accounts/user-profiles/root-attributes)
* [ユーザーデータの保存場所](/docs/ja-jp/secure/security-guidance/data-security/user-data-storage)