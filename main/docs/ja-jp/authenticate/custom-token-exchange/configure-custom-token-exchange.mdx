...
カスタムトークン交換を有効にするには、[新しいアプリケーションを作成](/docs/ja-jp/get-started/auth0-overview/create-applications)するか、Auth0 Dashboard または Management API を使用して既存のアプリケーションを更新します。カスタムトークン交換で使用するために、複数のアプリケーションを作成できます。
...
3. ご使用のアプリケーションが[ファーストパーティ](/docs/ja-jp/get-started/applications/first-party-and-third-party-applications)として設定され、**[Auth0 Dashboard &gt; アプリケーション &gt; 詳細設定 &gt; OAuth](/docs/ja-jp/get-started/applications/application-settings#oauth)** で OIDC 準拠として構成されていることを確認します。
