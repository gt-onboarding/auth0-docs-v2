...
リフレッシュトークンメタデータを設定するには、Auth0 の [Post-Login Action](/docs/ja-jp/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger) と [Management API](https://auth0.com/docs/api/management/v2) を使用できます。
