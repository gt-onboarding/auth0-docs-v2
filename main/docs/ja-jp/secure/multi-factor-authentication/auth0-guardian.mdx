...
Auth0 Guardian は、iOS および Android デバイス向けのモバイルアプリケーションで、ユーザーはプッシュ通知または一時的なワンタイムパスワードを使用して[多要素認証 (MFA)](/docs/ja-jp/secure/multi-factor-authentication)を完了できます。
