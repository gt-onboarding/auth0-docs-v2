export const LoggedInForm = ({ sampleApp }) => {
  ...
  function loadApps() {
    ...
    // スクリーンショットに表示されている3つを初期データとして設定する
            ...
            <Card className="p-5 hover:shadow-md transition">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <h2 className="text-lg">サンプルアプリケーションを見る</h2>
                </div>
                <RightChevron className="w-4 h-4 text-zinc-500" />
              </div>
            </Card>
  ...
  function CreateForm({ onSave, onCancel }) {
    ...
    return (
      <div className="space-y-6">
        ...
        <p className="text-sm text-zinc-500">この名前は後からアプリケーションの設定で変更できます。</p>
