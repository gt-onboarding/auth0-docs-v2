    ...
    links: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Your プライバシー Choices", href: "https://auth0.com/your-privacy-choices" }
        ]
      }
    ]
  }
      ...
      <div className="flex w-full flex-col gap-12 justify-between px-8 py-16 md:py-20 lg:py-28 max-w-[984px] z-0">
        <div className="flex flex-col md:flex-row gap-8 justify-between min-h-[76px]">
          ...
          <div className="flex md:flex-col justify-between items-center md:items-start min-w-16 md:min-w-20 lg:min-w-48 md:gap-y-24">
            <a href="/">
              <span className="sr-only">Auth0 ドキュメント home page</span>
              <img className="nav-logo w-auto relative object-contain block dark:hidden max-w-48 h-[26px]" alt="Auth0 ドキュメント" src="/docs/images/logo/light.svg" />
              <img className="nav-logo w-auto relative object-contain hidden dark:block max-w-48 h-[26px]" alt="Auth0 ドキュメント" src="/docs/images/logo/dark.svg" />
            </a>
